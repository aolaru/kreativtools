...
- Current product version: `v0.9.4`
...
- Workflows: guided workflow layer above the tool library, currently live with Image Prep and PDF Delivery
...
6. Optionally create a matching git tag like `v0.9.4`.
